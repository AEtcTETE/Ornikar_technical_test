const { footerFragment, mainPage, administratifPage, categorieVehiculePage, constructeursPage,couverturePage,indemnisationPage, jeuneConducteurPage, sinistrePage, souscriptionPage } = inject();
let state = {};
